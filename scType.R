...
pbmc.data <- Read10X(data.dir = "/Users/hyunjaecho/Downloads/pbmc5k/")
# Initialize the Seurat object with the raw (non-normalized data).
#gene_expression_matrix <- pbmc.data$`Gene Expression`
gene_expression_matrix <- pbmc.data

pbmc <- CreateSeuratObject(counts = gene_expression_matrix, project = "pbmc5k", min.cells = 3, min.features = 200)
...
barcodes <- read.table("/Users/hyunjaecho/Downloads/pbmc5k/barcodes.tsv", header = TRUE, sep = "\t")
